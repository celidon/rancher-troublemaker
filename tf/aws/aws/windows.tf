resource "aws_instance" "troublemaker_node_win" {
  depends_on = [
  ...
  user_data = templatefile(
    "${path.module}/files/userdata_troublemaker_windows.template",
    {
  ...
  tags = {
    Name    = "${var.prefix}-troublemaker-win"
